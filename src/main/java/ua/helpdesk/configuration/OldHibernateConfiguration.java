...
public class OldHibernateConfiguration {
    ...
    private Properties hibernateProperties() {
        ...
        properties.put("hibernate.useUnicode", environment.getRequiredProperty("hibernate.useUnicode"));

//        properties.put("hibernate.connection.charSet", environment.getRequiredProperty("hibernate.connection.charSet"));
//        properties.put("hibernate.connection.characterEncoding", environment.getRequiredProperty("hibernate.connection.charSet"));
